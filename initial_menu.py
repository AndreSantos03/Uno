...
play_rect = play_img.get_rect(center=(global_variables.WIDTH/2, global_variables.HEIGHT / 1.45))
settings_img = buttons_font.render('SETTINGS',True,font_color)
settings_rect = settings_img.get_rect(center=(global_variables.WIDTH/2, global_variables.HEIGHT / 1.45 + global_variables.HEIGHT / 10))
quit_img = buttons_font.render('QUIT',True,font_color)
quit_rect = quit_img.get_rect(center=(global_variables.WIDTH/2, global_variables.HEIGHT / 1.45 + global_variables.HEIGHT / 10 * 2))
...
resolution_options_rect = resolution_options_img.get_rect(center=(global_variables.WIDTH / 3,global_variables.HEIGHT / 4))
resolution_img = options_font.render("{}x{}".format(int(global_variables.WIDTH),int(global_variables.HEIGHT)),True,(255,255,255))
resolution_rect = resolution_img.get_rect(center=(global_variables.WIDTH / 3 + global_variables.WIDTH / 7.25, global_variables.HEIGHT / 4))

#volume
music_volume_img = options_font.render("Music Volume:",True,(255,255,255))
music_volume_rect = resolution_options_img.get_rect(center=(global_variables.WIDTH / 3,global_variables.HEIGHT / 4  + global_variables.HEIGHT / 14))
percentage_sign_image = options_font.render("%",True,(255,255,255))
percentage_sign_rect_1 = resolution_options_img.get_rect(center=(global_variables.WIDTH / 3 + global_variables.WIDTH / 3.75,global_variables.HEIGHT / 4 + global_variables.HEIGHT / 14))
m_volume_value_img = options_font.render("{}".format(global_variables.MUSIC_VOLUME * 100),True,(255,255,255))
m_volume_value_rect = m_volume_value_img.get_rect(center = (global_variables.WIDTH / 3 + global_variables.WIDTH / 4.7,global_variables.HEIGHT / 4 + global_variables.HEIGHT / 14))
left_arrow = pygame.image.load(global_variables.LEFT_ARROW)
left_arrow = pygame.transform.scale(left_arrow,(global_variables.WIDTH/20,global_variables.HEIGHT/30))
left_arrow_rect_1 = left_arrow.get_rect(center=(global_variables.WIDTH / 3 + global_variables.WIDTH / 9,global_variables.HEIGHT / 4 + global_variables.HEIGHT / 14))
right_arrow = pygame.image.load(global_variables.RIGHT_ARROW)
right_arrow = pygame.transform.scale(right_arrow,(global_variables.WIDTH/20,global_variables.HEIGHT/30))
right_arrow_rect_1 = right_arrow.get_rect(center=(global_variables.WIDTH / 3 + global_variables.WIDTH / 6,global_variables.HEIGHT / 4 + global_variables.HEIGHT / 14))
effects_volume_img = options_font.render("Effects Volume:",True,(255,255,255))
effects_volume_rect = resolution_options_img.get_rect(center=(global_variables.WIDTH / 3,global_variables.HEIGHT / 4 + global_variables.HEIGHT / 14 * 2))
percentage_sign_rect_2 = resolution_options_img.get_rect(center=(global_variables.WIDTH / 3 + global_variables.WIDTH / 3.75,global_variables.HEIGHT / 4 + global_variables.HEIGHT / 14 * 2))
effects_volume_value_img = options_font.render("{}".format(int(global_variables.EFFECTS_VOLUME * 100)),True,(255,255,255))
effects_volume_value_rect = m_volume_value_img.get_rect(center = (global_variables.WIDTH / 3 + global_variables.WIDTH / 4.7,global_variables.HEIGHT / 4 + global_variables.HEIGHT / 14 * 2))
left_arrow_rect_2 = left_arrow.get_rect(center=(global_variables.WIDTH / 3 + global_variables.WIDTH / 9,global_variables.HEIGHT / 4 + global_variables.HEIGHT / 14 * 2))
right_arrow_rect_2 = right_arrow.get_rect(center=(global_variables.WIDTH / 3 + global_variables.WIDTH / 6,global_variables.HEIGHT / 4 + + global_variables.HEIGHT / 14 * 2))
fps_image = options_font.render("FPS:",True,(255,255,255))
fps_rect = resolution_options_img.get_rect(center=(global_variables.WIDTH / 3,global_variables.HEIGHT / 4 + global_variables.HEIGHT / 14 * 3))
fps_value_image = options_font.render("{}".format(global_variables.FPS),True,(255,255,255))
fps_value_rect = fps_value_image.get_rect(center = (global_variables.WIDTH / 3 + global_variables.WIDTH / 4.7,global_variables.HEIGHT / 4 + global_variables.HEIGHT / 14 * 3))
left_arrow_rect_3 = left_arrow.get_rect(center=(global_variables.WIDTH / 3 + global_variables.WIDTH / 9,global_variables.HEIGHT / 4 + global_variables.HEIGHT / 14 * 3))
...
def loading_image(screen):
    ...
    loading_rect = loading_image.get_rect(center=(global_variables.WIDTH/2,global_variables.HEIGHT/2))
